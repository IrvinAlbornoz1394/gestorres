                ...
                <div class="col-lg-12">
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <div class="row">
                                <div class="col-md-12">
                                    <button class="pull-right btn btn-primary">Nuevo <i class="fa fa-plus"></i></button>
                                    <table class="table table-striped table-hover table-personas table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>Irvin Albornoz Vazquez</td>
                                                <td>Calle 105 # 443D x 52A y 54</td>
                                                <td>Col Dolores Otero</td>
                                                <td>54345532453</td>
                                                <td>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select data-placeholder="Choose a Country..." class="chosen-select" style="width: 200px;">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                        <select data-placeholder="Choose a Country..." class="chosen-select" style="width: 300px;">
